...
export const MenuLinks = [
  ...
  { id: 4, name: "Partners", link: "/#partner" },
];
      ...
      <div className="container py-3 md:py-2">
        <div className="flex justify-between items-center">
          ...
          <a href="#home" className="flex items-center gap-3 bg-white p-1 rounded">
            ...
            <span className="text-xl sm:text-1xl font-semibold">MINEMA</span>
          </a>
            ...
            <ul className="flex items-center gap-8">
              ...
              <li className="py-4">
                <button
                  ...
                  className="bg-sky-900 text-white py-2 px-4 rounded hover:bg-gray-900 transition-colors duration-300"
                >
                  Login
                </button>
              </li>
