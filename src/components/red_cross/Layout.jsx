        ...
        <div className="max-w-[2000px] mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex md:items-center md:space-x-4">
              <button
                onClick={() => handleLinkClick('/red_cross')}
              ...
              <button
                onClick={() => handleLinkClick('/red_cross/preventions')}
                className="px-4 py-2 text-white hover:bg-black rounded-md flex items-center space-x-2"
              >
              ...
              {userId ? (
                <button
                  onClick={() => handleLinkClick(`/red_cross/profile/${userId}`)}
                  className="px-4 py-2 text-white hover:bg-black rounded-md flex items-center space-x-2"
                >
...
export default Red_Cross_Layout;