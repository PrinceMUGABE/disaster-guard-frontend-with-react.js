...
import loginImage from '../../assets/pictures/Background-Image.png'; // Assuming the path to the image
      ...
      <div className="relative sm:max-w-md max-w-md w-full space-y-8 bg-white bg-opacity-90 rounded-lg shadow-lg p-8 z-10">
        ...
        <form className="mt-8 space-y-2" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="w-full bg-sky-900 text-white py-2 px-4 rounded-md shadow-sm hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              disabled={loading}
            >
        ...
        <div className="mt-3 text-sm text-gray-600">
          Already have an account? <Link to="/login" className="text-sky-900 hover:text-black">Log in here</Link>
        </div>
      </div>
    </div>
  );
